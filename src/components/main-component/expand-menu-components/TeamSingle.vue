<template>
  <article class="team-member__wrapper">
    <div class="team-member__top-bg">
      <div class="git-logo">
        <a
          v-if="teamMember === 'Stefan'"
          class="name"
          href="https://github.com/StefanH87"
          >Stefan Hiob</a
        >
        <a
          v-if="teamMember === 'Kirsten'"
          class="name"
          href="https://github.com/kiraGit67"
          >Kirsten Anders</a
        >
        <a
        ...
        <a
          ...
          class="name"
          href="https://github.com/kerstin-m"
          >Kerstin Merk</a
        >
        <a v-if="teamMember === 'Stefan'" href="https://github.com/StefanH87"
          ><svg
        ...
        <a v-if="teamMember === 'Kirsten'" href="https://github.com/kiraGit67"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            height="100%"
        ...
        <a v-if="teamMember === 'Daniel'" href="https://github.com/danielkull"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            height="100%"
        ...
        <a v-if="teamMember === 'Kerstin'" href="https://github.com/kerstin-m"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            height="100%"
...
.team-member__wrapper {
  width: 100%;
  border-right: var(--m-brd) solid var(--primary-middle);
  border-bottom: var(--m-brd) solid var(--primary-middle);
  background: linear-gradient(
    to top,
    var(--menue-bg) 40%,
    var(--primary-middle) 40%
  );
...
.logo-wrapper {
  ...
  background: var(--menue-bg);
  box-shadow: 0 -10px 15px var(--shd-single-cards);
